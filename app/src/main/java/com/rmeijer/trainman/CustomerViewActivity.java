...
public class CustomerViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (fragment_f22 == null) {
            ...
            // should call CustomerViewFragment.newInstance(UUID)
            // when it needs to create a CustomerViewFragment
            //fragment_f22 = new CustomerViewFragment();
    ...
    public static Intent newIntent(Context packageContext, UUID customerId) {
        Intent intent = new Intent(packageContext, CustomerViewActivity.class);
    ...
    protected Fragment createFragment() {
        // 10.7 - Using newInstance(UUID)
        //return new CustomerEnterFragment();
        UUID customerId = (UUID) getIntent()
                .getSerializableExtra(EXTRA_CUSTOMER_ID);
        return CustomerViewFragment.newInstance(customerId);
