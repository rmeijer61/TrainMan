...
public class SessionEnterActivity extends AppCompatActivity {
    ...
    public static Intent newIntent(Context packageContext, UUID customerId) {
        Intent intent = new Intent(packageContext, SessionEnterActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_session_enter);
        ...
        // 7.16 - Adding a SessionEnterFragment
        ...
        if (fragment_fESess3 == null) {
            fragment_fESess3 = new SessionEnterFragment();
            fm.beginTransaction()
